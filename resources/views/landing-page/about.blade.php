<x-layout-landing>
    ...
    <main class=" px-10 w-full h-auto sm:w-4/5 sm:px-2 mx-auto">
        ...
        <div class="px-7 md:px-8">
            ...
            <form action="" method="">
                <div class="flex items-center bg-white w-fit sm:py-[6px] sm:px-4 py-1 px-3 sm:rounded-xl rounded-lg">
                    ...
                    <button type="submit" class="bg-blue-500 sm:py-[6px] sm:px-3 py-1 px-1 rounded-full text-slate-50 hover:bg-blue-300 hover:text-slate-600 font-medium sm:text-sm text-xs shadow-md transition-all" title="subscribe">
      ...
      <div class="text-sm text-slate-700 w-full">
        <h2 class="font-semibold sm:text-base mt-4 mb-2">Our Mission</h2>
        <p class="font-light">Our mission at Turbo Rookie is to cultivate a supportive and inclusive environment where aspiring web developers can learn, collaborate, and thrive. We aim to provide valuable resources, mentorship, and hands-on experiences that empower our members to become skilled professionals and innovative thinkers in the ever-evolving field of web development.</p>

        <h2 class="font-semibold sm:text-base mt-4 mb-2">Our Expertise</h2>
        <div class="flex  justify-center flex-wrap">
          <div class="w-full sm:w-44 border border-slate-300 p-2 sm:p-4 rounded-md mx-1 my-2">
            <svg class="w-5 h-5" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
            ...
            <h3 class="font-semibold text-sm sm:text-base">HTML</h3>
            <p class="font-thin text-xs sm:text-sm">Master the structure of web pages with HyperText Markup Language, laying the foundation for your web development journey.</p>  
          </div>
          <div class="w-full sm:w-44 border border-slate-300 p-2 sm:p-4 rounded-md mx-1 my-2">
            <svg class="w-5 h-5" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
            ...
            <h3 class="font-semibold text-sm sm:text-base">CSS</h3>
            <p class="font-thin text-xs sm:text-sm">Learn how to style and design your web pages using Cascading Style Sheets, creating visually appealing layouts and responsive designs.</p>  
          </div>
          <div class="w-full sm:w-44 border border-slate-300 p-2 sm:p-4 rounded-md mx-1 my-2">
            ...
            <h3 class="font-semibold text-sm sm:text-base">Bootstrap</h3>
            <p class="font-thin text-xs sm:text-sm">Discover the power of this popular front-end framework to build responsive and mobile-first websites efficiently.</p>  
          </div>
          <div class="w-full sm:w-44 border border-slate-300 p-2 sm:p-4 rounded-md mx-1 my-2">
            <svg class="w-7 h-7" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <title>php</title>
            ...
            <h3 class="font-semibold text-sm sm:text-base">PHP</h3>
            <p class="font-thin text-xs sm:text-sm">Dive into server-side programming with PHP, enabling you to create dynamic web applications and manage data effectively.</p>  
          </div>
          <div class="w-full sm:w-44 border border-slate-300 p-2 sm:p-4 rounded-md mx-1 my-2">
        ...
        <div class="flex  justify-center flex-wrap">
          <a href="#" class="w-full p-2 sm:p-4 rounded-xl mx-1 my-2 flex items-center hover:shadow-lg transition-all border border-slate-300">
            ...
            <div>
              <h3 class="font-semibold text-sm sm:text-base">Septa</h3>
              <h3 class="font-light text-xs">Mentor</h3>
