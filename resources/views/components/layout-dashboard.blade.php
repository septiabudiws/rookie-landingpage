          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ Request::is('dashboard*', 'member*', 'data_blog*', 'data_project*') ? 'active open' : 'close' }}">
              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="/member" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">Member</div>
                  </a>
                </li>
              </ul>
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="/data_blog" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">Blog</div>
                  </a>
                </li>
              </ul>
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="/data_project" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">Projects</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <li class="menu-item {{ Request::is('status_member*', 'status_project*', 'kategori*') ? 'active open' : 'close' }}">
                ...
                <ul class="menu-sub">
                  <li class="menu-item active">
                    <a href="/status_member" class="menu-link">
                      <div class="text-truncate" data-i18n="Analytics">Status Member</div>
                    </a>
                  </li>
                </ul>
                <ul class="menu-sub">
                  <li class="menu-item active">
                    <a href="/status_project" class="menu-link">
                      <div class="text-truncate" data-i18n="Analytics">Status Project</div>
                    </a>
                  </li>
                </ul>
                <ul class="menu-sub">
