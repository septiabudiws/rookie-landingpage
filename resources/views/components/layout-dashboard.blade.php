      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ Request::is('rekap') ? 'active': '' }}">
              <a href="/rekap" class="menu-link">
                <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
                <div class="text-truncate" data-i18n="Basic">Rekap</div>
              </a>
            </li>
            <li class="menu-item {{ Request::is('izin') ? 'active': '' }}">
              <a href="/izin" class="menu-link">
                <i class="menu-icon tf-icons bx bx-time"></i>
                <div class="text-truncate" data-i18n="Basic">Izin</div>
              </a>
            </li>
        ...
        <div class="layout-page">
          ...
          <nav
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                ...
                <h5 class="card-title text-secondary">Welcome Jhon !</h5>
                {{-- welcome --}}
